...
namespace Bookify.Web.Core.Models
{
    ...
    public class SubscriberFormViewModel : BaseViewModel
    {
        ...
        [Remote(controller: "Subscribers", action: "AllowNationalId", AdditionalFields = nameof(Key), ErrorMessage = Errors.Duplicated)]
        ...
        [Remote(controller: "Subscribers", action: "AllowMobileNumber", AdditionalFields = nameof(Key), ErrorMessage = Errors.Duplicated)]

        public string MobileNumber { get; set; } = null!;
        public bool HasWhatsApp { get; set; }
        [MaxLength(150)]
        [EmailAddress]
        [Remote(controller: "Subscribers", action: "AllowEmail", AdditionalFields = nameof(Key), ErrorMessage = Errors.Duplicated)]
